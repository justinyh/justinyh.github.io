...
export default async function Home() {
  ...
  const resumeUrl = isMediaType(home.resume) && home.resume.url ? home.resume.url : "";
  return (
    <main className="">
      <Container>
        <div className="flex flex-col mt-12 gap-32">
          <SideBySide sx="flex-col-reverse items-center" gap={8}>
            <div className="sm:max-w-72 md:max-w-96 lg:max-w-none">
              <Heading className="sm:text-3xl md:text-4xl xl:text-5xl">Hey, I'm Justin!</Heading>
              ...
              <div className="mt-6">
                <ButtonGroup>
                  <LinkButton href={resumeUrl} newTab>Resume</LinkButton>
